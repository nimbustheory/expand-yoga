...
// ═══════════════════════════════════════════════════════════════
//  STUDIO_CONFIG — Expand Yoga, Tacoma
// ═══════════════════════════════════════════════════════════════
const STUDIO_CONFIG = {
  name: "EXPAND",
  subtitle: "YOGA",
  ...
  logoMark: "EX",
  description: "Tacoma's home for hot yoga, vinyasa, and strength. Two locations, powerful classes, and a community that shows up for each other.",
  heroLine1: "WORK",
  heroLine2: "HARD",

  address: { street: "3909 6th Ave", city: "Tacoma", state: "WA", zip: "98406" },
  phone: "(253) 886-7820",
  email: "expandyoga@gmail.com",
  neighborhood: "6th Ave District, Tacoma",
  website: "https://www.expandyoga.com",
  social: { instagram: "@expandyoga" },

  theme: {
    accent:     { h: 18, s: 85, l: 52 },   // Warm amber/gold
    accentAlt:  { h: 210, s: 50, l: 50 },    // Soft violet
    warning:    { h: 45, s: 80, l: 50 },     // Burnt orange
    primary:    { h: 215, s: 25, l: 11 },     // Deep midnight blue
    surface:    { h: 210, s: 8, l: 97 },     // Cool white
    surfaceDim: { h: 210, s: 10, l: 93 },     // Soft gray
  },
...
// ═══════════════════════════════════════════════════════════════
//  MOCK DATA — Expand Yoga content
// ═══════════════════════════════════════════════════════════════
const TEACHERS = [
  { id: "t1", firstName: "Matt", lastName: "Ottenbach", role: "Lead Teacher & TT Faculty", certs: ["E-RYT 500", "Baptiste Certified"], specialties: ["Original Hot 26", "Hot Vinyasa", "Teacher Training"], yearsTeaching: 12, bio: "Matt is one of Expand's founding teachers and leads the 200-hour teacher training program. His Original Hot classes are legendary — precise, challenging, and deeply grounding. He has shaped the studio's teaching culture from day one." },
  { id: "t2", firstName: "Patrick", lastName: "Good", role: "Senior Teacher & TT Faculty", certs: ["E-RYT 500"], specialties: ["Hot Vinyasa", "Katonah Yoga", "Philosophy"], yearsTeaching: 10, bio: "Patrick brings a rare blend of physical intensity and philosophical depth. His Katonah Yoga classes explore sacred geometry for the body — blending Taoist theory, geometry, pranayama, and meditation into a practice that's been described as transformative." },
  { id: "t3", firstName: "Katie", lastName: "Gumucio", role: "Senior Teacher & TT Faculty", certs: ["E-RYT 500"], specialties: ["Original Hot 26", "Yin", "Candlelight Vinyasa"], yearsTeaching: 9, bio: "Katie's teaching is precise and compassionate. She creates classes that challenge you while making you feel completely supported. Her Sunday Candlelight Vinyasa is a community favorite — the perfect way to reset for the week." },
  { id: "t4", firstName: "Sarah", lastName: "M.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Vinyasa", "Strength & Sculpt"], yearsTeaching: 4, bio: "Sarah's Strength & Sculpt classes use weights, resistance bands, and bodyweight to build functional strength. Great music keeps the beat — you'll be sore for days, but there will be no regrets." },
  { id: "t5", firstName: "Jordan", lastName: "R.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Vinyasa", "Barre Yoga"], yearsTeaching: 3, bio: "Jordan combines the toning elements of barre with yoga's flexibility and mindfulness. Her classes offer a comprehensive workout that leaves you feeling balanced, strong, and energized." },
  { id: "t6", firstName: "Mika", lastName: "T.", role: "Teacher", certs: ["RYT-200"], specialties: ["Yin", "Original Hot 26"], yearsTeaching: 5, bio: "Mika's Yin classes are the perfect complement to the heat. Slow, deep, and meditative — designed to release what the power classes build. Think stretching and deep release." },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Hot Vinyasa", type: "VINYASA",
  style: "Hot Vinyasa", temp: "95°F", duration: 60,
  description: "An all-levels strong, fun, flowing class focused on moving mindfully in connection with your breath. Postures and sequencing vary from class to class and teacher to teacher. Come prepared to play along your edge.",
  intention: "Work hard. Have fun. Leave happy.",
  teacherTip: "While music is often played, it takes second seat to your breath. Let the breath lead.",
  playlist: "Expand Flow — Matt's Mix",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Original Hot 26", type: "HOT26", style: "Original Hot", temp: "105°F", duration: 90, description: "The classic 26 posture and 2 breathing exercise series. Systematically stretches, strengthens, and balances your body. Heated to 105°F for deep detoxification.", intention: "The postures do the work. Trust the heat. Trust the process.", teacherTip: "Stay in the room. That's the only rule. Everything else is optional." },
  { id: "p-y2", date: offsetDate(-2), name: "Yin Yoga", type: "YIN", style: "Yin", temp: "Room Temp", duration: 60, description: "A slower paced, relaxed style involving seated and supine postures held for 3-5 minutes. Think stretching and deep release. Designed to prepare the body for ease in seated meditation.", intention: "Stillness is not the absence of movement. It's the presence of awareness.", teacherTip: "Yin complements vigorous practices like Vinyasa and Hot 26. Do both." },
  { id: "p-y3", date: offsetDate(-3), name: "Strength & Sculpt", type: "SCULPT", style: "Sculpt", temp: "Warm", duration: 45, description: "High energy, muscularly challenging. Weights, resistance bands, lunges, squats, rows, curls, planks and sit-ups. Everything is modifiable -- listen to your body.", intention: "Find grace in the grit. Strength is built in the struggle." },
  { id: "p-y4", date: offsetDate(-4), name: "Katonah Yoga", type: "SPECIAL", style: "Katonah", temp: "Room Temp", duration: 75, description: "Sacred geometry for the body. Blending Taoist theory, geometry, pranayama, and meditation into a deeply structured practice. Patrick Good leads you through body readings and alignment architecture.", intention: "Your body is your house. Learn its architecture.", teacherTip: "Katonah uses props extensively. Grab two blocks and a strap before class." },
  { id: "p-y5", date: offsetDate(-5), name: "Hot Vinyasa", type: "VINYASA", style: "Hot Vinyasa", temp: "95°F", duration: 60, description: "An all-levels strong, fun, flowing class focused on moving mindfully in connection with your breath. Postures and sequencing vary from class to class and teacher to teacher.", intention: "Let the breath lead. The body will follow.", teacherTip: "While music is often played, it takes second seat to your breath." },
  { id: "p-y6", date: offsetDate(-6), name: "Barre Yoga", type: "SPECIAL", style: "Barre", temp: "Room Temp", duration: 50, description: "Combines the toning elements of barre with yoga's flexibility and mindfulness. Low-impact, high-repetition movements that sculpt lean muscle while improving balance and posture.", intention: "Small movements, big changes. Meet your edge with patience.", teacherTip: "Grip socks recommended but not required. Bare feet work great too." },
  { id: "p-y7", date: offsetDate(-7), name: "Original Hot 26", type: "HOT26", style: "Original Hot", temp: "105°F", duration: 90, description: "The classic 26 posture and 2 breathing exercise series. Each class is the same sequence, allowing you to measure your progress over time. 105 degrees, 90 minutes, no exceptions.", intention: "Same postures, different body every day. That is the practice.", teacherTip: "Hydrate well before class. Bring a full water bottle and a towel for your mat." },
  { id: "p-y8", date: offsetDate(-9), name: "Silent Sunday Hot 26", type: "SPECIAL", style: "Silent Hot", temp: "105°F", duration: 90, description: "First Sunday of each month -- a 90-minute Original Hot 26 with no verbal instruction. You lead your own practice in the heat. Not ideal for new students.", intention: "You already know the way. Trust yourself.", teacherTip: "The teacher is in the room for safety but will not cue. This is your practice." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Sunday Candlelight Vinyasa", type: "SPECIAL", style: "Candlelight", temp: "Room Temp", duration: 60, description: "A candle-lit twist on regular vinyasa intended to support you in unwinding from your weekend and resetting for the week ahead. Flowing, grounding, magical.", intention: "Unwind. Reset. Begin again.", teacherTip: "Let the candlelight soften your gaze. Move from feeling, not thinking." };

const CLASSES_TODAY = [
  { id: "cl1", time: "06:00", type: "Original Hot 26 (105°F)", coach: "Matt Ottenbach", capacity: 35, registered: 30, waitlist: 0 },
  { id: "cl2", time: "07:30", type: "Hot Vinyasa (95°F)", coach: "Katie Gumucio", capacity: 35, registered: 35, waitlist: 4 },
  { id: "cl3", time: "09:30", type: "Original Hot 26 (105°F)", coach: "Patrick Good", capacity: 35, registered: 26, waitlist: 0 },
  { id: "cl4", time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Sarah M.", capacity: 35, registered: 18, waitlist: 0 },
  { id: "cl5", time: "16:30", type: "Strength & Sculpt (Warm)", coach: "Sarah M.", capacity: 30, registered: 28, waitlist: 0 },
  { id: "cl6", time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Matt Ottenbach", capacity: 35, registered: 35, waitlist: 5 },
  { id: "cl7", time: "19:30", type: "Yin", coach: "Mika T.", capacity: 25, registered: 20, waitlist: 0 },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "06:00", type: "Original Hot 26 (105°F)", coach: "Matt" }, { time: "07:30", type: "Hot Vinyasa (95°F)", coach: "Katie" }, { time: "09:30", type: "Hot 26 (105°F)", coach: "Patrick" }, { time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Sarah" }, { time: "16:30", type: "Sculpt (Warm)", coach: "Sarah" }, { time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Matt" }, { time: "19:30", type: "Yin", coach: "Mika" }] },
  { day: "Tuesday", classes: [{ time: "06:00", type: "Hot Vinyasa (95°F)", coach: "Patrick" }, { time: "07:30", type: "Original Hot 26 (105°F)", coach: "Katie" }, { time: "09:30", type: "Original Hot 26 (105°F)", coach: "Matt" }, { time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Katie" }, { time: "16:30", type: "Barre Yoga", coach: "Jordan" }, { time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Patrick" }, { time: "19:30", type: "Yin", coach: "Mika" }] },
  { day: "Wednesday", classes: [{ time: "06:00", type: "Original Hot 26 (105°F)", coach: "Katie" }, { time: "07:30", type: "Hot Vinyasa (95°F)", coach: "Matt" }, { time: "09:30", type: "Katonah Yoga", coach: "Patrick" }, { time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Sarah" }, { time: "16:30", type: "Sculpt (Warm)", coach: "Sarah" }, { time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Matt" }, { time: "19:30", type: "Yin", coach: "Mika" }] },
  { day: "Thursday", classes: [{ time: "06:00", type: "Hot Vinyasa (95°F)", coach: "Patrick" }, { time: "07:30", type: "Original Hot 26 (105°F)", coach: "Matt" }, { time: "09:30", type: "Original Hot 26 (105°F)", coach: "Katie" }, { time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Matt" }, { time: "16:30", type: "Barre Yoga", coach: "Jordan" }, { time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Sarah" }, { time: "19:30", type: "Yin", coach: "Mika" }] },
  { day: "Friday", classes: [{ time: "06:00", type: "Original Hot 26 (105°F)", coach: "Matt" }, { time: "07:30", type: "Hot Vinyasa (95°F)", coach: "Patrick" }, { time: "09:30", type: "Hot Vinyasa (95°F)", coach: "Katie" }, { time: "12:00", type: "Hot Vinyasa (95°F)", coach: "Patrick" }, { time: "16:30", type: "Sculpt (Warm)", coach: "Sarah" }, { time: "17:45", type: "Hot Vinyasa (95°F)", coach: "Matt" }] },
  { day: "Saturday", classes: [{ time: "08:00", type: "Original Hot 26 (105°F)", coach: "Matt" }, { time: "09:30", type: "Hot Vinyasa (95°F)", coach: "Katie" }, { time: "11:00", type: "Sculpt (Warm)", coach: "Sarah" }, { time: "12:30", type: "Yin", coach: "Mika" }, { time: "16:00", type: "Hot Vinyasa (95°F)", coach: "Patrick" }] },
  { day: "Sunday", classes: [{ time: "08:00", type: "Original Hot 26 (105°F)", coach: "Patrick" }, { time: "09:30", type: "Hot Vinyasa (95°F)", coach: "Matt" }, { time: "11:00", type: "Candlelight Vinyasa", coach: "Katie" }, { time: "12:30", type: "Katonah Yoga", coach: "Patrick" }, { time: "17:00", type: "Yin", coach: "Mika" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Ashley M.", milestone: "100 Classes", message: "Favorite yoga studio in Tacoma! The instructors are kind, the variety is fantastic, and I always leave feeling uplifted.", date: today, celebrations: 32 },
  { id: "cf2", user: "Chris D.", milestone: "30-Day Streak", message: "My first hot yoga experience was amazing at Expand. Thirty days later I can't imagine life without it.", date: today, celebrations: 22 },
  { id: "cf3", user: "Jamie K.", milestone: "First Hot 26!", message: "I stayed in the room the whole time! 105 degrees and 90 minutes — I did it! Thank you Matt for the encouragement.", date: offsetDate(-1), celebrations: 48 },
  { id: "cf4", user: "Sam R.", milestone: "1 Year Member", message: "One year at Expand. The positive energy hits you the moment you walk through the door. This community is everything.", date: offsetDate(-1), celebrations: 44 },
];
...
const EVENTS = [
  { id: "ev1", name: "200-Hour Yoga Teacher Training", date: "2026-09-01", startTime: "09:00", type: "Training", description: "Led by Matt Ottenbach, Patrick Good, and Katie Gumucio. Learn to teach in a real public class setting — not just theory. Includes anatomy, alignment, philosophy, meditation, and CPR certification. $3,500 tuition.", fee: 3500, maxParticipants: 16, registered: 8, status: "Registration Open" },
  { id: "ev2", name: "Silent Sunday Original Hot 26", date: "2026-04-12", startTime: "10:00", type: "Special Class", description: "First Sunday of each month — a 90-minute Original Hot 26 with no verbal instruction. You lead your own practice. Tacoma location only. Not ideal for new students.", fee: 0, maxParticipants: 35, registered: 28, status: "Open" },
  { id: "ev3", name: "Katonah Yoga Workshop", date: "2026-05-16", startTime: "13:00", type: "Workshop", description: "Sacred geometry for the body with Patrick Good. Explore Taoist theory, pranayama, body readings, and the architecture of alignment in this 3-hour immersive.", fee: 45, maxParticipants: 25, registered: 12, status: "Registration Open" },
  { id: "ev4", name: "300-Hour Advanced Studies", date: "2026-06-01", startTime: "09:00", type: "Training", description: "Monthly qualifying workshops building toward your 300-hour certification. Deepen your teaching practice with Expand's senior faculty.", fee: 75, maxParticipants: 20, registered: 10, status: "Ongoing" },
];

const MEMBERSHIP_TIERS = [
  { id: "m1", name: "Drop-In", type: "drop-in", price: 28, period: "per class", features: ["1 class credit", "Walk-ins welcome", "Both Tacoma & Federal Way locations"], popular: false },
  { id: "m2", name: "10 Class Pack", type: "pack", price: 199, period: "10 classes", features: ["10 class credits", "Valid for 6 months", "Both locations"], popular: false },
  { id: "m3", name: "4 Class Pass", type: "monthly", price: 89, period: "/month", features: ["4 classes per month", "Both locations", "Auto-renew monthly"], popular: false },
  { id: "m4", name: "8 Class Pass", type: "monthly", price: 119, period: "/month", features: ["8 classes per month", "Both locations", "Priority booking", "Auto-renew monthly"], popular: false },
  { id: "m5", name: "Unlimited", type: "unlimited", price: 150, period: "/month", features: ["Unlimited classes", "Both locations", "Priority booking", "20% off workshops", "Guest passes", "Student rate: $75/mo"], popular: true },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "Federal Way Studio Now Open!", message: "Our second location is thriving. Same great classes, same community energy. Walk-ins always welcome at both studios.", type: "celebration", pinned: true },
  { id: "a2", title: "New: Barre Yoga with Jordan", message: "Combining toning barre work with yoga flexibility. Tuesdays and Thursdays at 4:30 PM.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Ashley Martinez", email: "ashley@email.com", membership: "Unlimited", status: "active", joined: "2023-04-01", checkIns: 286, lastVisit: today },
  { id: "mem2", name: "Chris Donovan", email: "chris@email.com", membership: "Unlimited", status: "active", joined: "2022-11-15", checkIns: 398, lastVisit: offsetDate(-1) },
  { id: "mem3", name: "Jamie Kim", email: "jamie@email.com", membership: "8 Class Pass", status: "active", joined: "2025-08-01", checkIns: 54, lastVisit: offsetDate(-2) },
  { id: "mem4", name: "Sam Reeves", email: "sam@email.com", membership: "Unlimited", status: "active", joined: "2025-03-24", checkIns: 152, lastVisit: today },
  { id: "mem5", name: "Dana Lee", email: "dana@email.com", membership: "Unlimited", status: "frozen", joined: "2024-05-01", checkIns: 96, lastVisit: offsetDate(-30) },
  { id: "mem6", name: "Tyler Wong", email: "tyler@email.com", membership: "10 Class Pack", status: "active", joined: "2026-01-10", checkIns: 4, lastVisit: offsetDate(-5) },
  { id: "mem7", name: "Rachel Torres", email: "rachel@email.com", membership: "Unlimited", status: "active", joined: "2023-07-01", checkIns: 218, lastVisit: today },
  { id: "mem8", name: "Alex Nguyen", email: "alex@email.com", membership: "4 Class Pass", status: "active", joined: "2025-12-01", checkIns: 12, lastVisit: offsetDate(-3) },
];

const ADMIN_METRICS = {
  activeMembers: 224, memberChange: 16,
  todayCheckIns: 86, weekCheckIns: 512,
  monthlyRevenue: 33600, revenueChange: 10.4,
  workshopRevenue: 4800,
};

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 92, avg: 13 }, { day: "Tue", total: 72, avg: 14 },
    { day: "Wed", total: 84, avg: 14 }, { day: "Thu", total: 78, avg: 13 },
    { day: "Fri", total: 62, avg: 16 }, { day: "Sat", total: 38, avg: 19 },
    { day: "Sun", total: 52, avg: 17 },
  ],
  revenue: [
    { month: "Sep", revenue: 27400 }, { month: "Oct", revenue: 28800 },
    { month: "Nov", revenue: 30200 }, { month: "Dec", revenue: 28600 },
    { month: "Jan", revenue: 31800 }, { month: "Feb", revenue: 32400 },
    { month: "Mar", revenue: 33600 },
  ],
  classPopularity: [
    { name: "6:00 AM", pct: 86 }, { name: "7:30 AM", pct: 100 },
    { name: "9:30 AM", pct: 74 }, { name: "12:00 PM", pct: 52 },
    { name: "4:30 PM", pct: 94 }, { name: "5:45 PM", pct: 100 },
    { name: "7:30 PM", pct: 80 },
  ],
  membershipBreakdown: [
    { name: "Unlimited", value: 108, color: T.accent },
    { name: "8 Class Pass", value: 48, color: T.success },
    { name: "4 Class Pass", value: 32, color: T.warning },
    { name: "Class Packs", value: 24, color: T.textMuted },
...
function TeachersPage() {
  ...
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Teachers" subtitle="Meet the Expand teaching team" image={STUDIO_IMAGES.teacherTraining} />
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
function MembershipPage() {
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Membership" subtitle="Find your practice at both locations" image={STUDIO_IMAGES.pricing} />
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              {tier.name === "Unlimited" ? <Flame size={24} color={T.accent} /> : tier.name === "8 Class" ? <Dumbbell size={24} color={T.accent} /> : tier.name === "4 Class" ? <Leaf size={24} color={T.accent} /> : <Moon size={24} color={T.accent} />}
...
function EventsPage() {
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Events" subtitle="Trainings, workshops, and special classes" image={STUDIO_IMAGES.events} />
      {EVENTS.map(ev => (
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Dashboard</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#161a2a", border: "1px solid #2a2e42", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Syne', serif", fontSize: 30, color: "#fff", fontWeight: 700 }}>{m.value}</div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Members</h1>
          ...
          <tbody>
            {filtered.map(m => (
              <tr key={m.id} style={{ borderBottom: "1px solid #2a2e42" }}>
                ...
                <td style={{ padding: "12px 16px" }}>
                  <div style={{ display: "flex", gap: 6 }}>
                    <button style={{ padding: "4px 8px", borderRadius: 4, border: "1px solid #2a2e42", background: "transparent", color: "#9ca3af", fontSize: 11, fontWeight: 600, cursor: "pointer" }}>Edit</button>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Schedule Management</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Teachers</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Events & Workshops</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
      ...
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#161a2a", border: "1px solid #2a2e42", borderRadius: 12, padding: 18 }}>
          ...
          <div style={{ display: "flex", gap: 6, marginTop: 14 }}>
            <button style={{ flex: 1, padding: "8px 12px", borderRadius: 6, border: "1px solid #2a2e42", background: "transparent", color: "#9ca3af", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Edit</button>
            <button style={{ flex: 1, padding: "8px 12px", borderRadius: 6, border: "1px solid #2a2e42", background: "transparent", color: "#f87171", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Delete</button>
          </div>
        </div>
      ))}
    </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Pricing & Memberships</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#161a2a", border: `1px solid ${tier.popular ? T.accent : "#2a2e42"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Syne', serif", fontSize: 22, color: "#fff", margin: "0 0 4px" }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Syne', serif", fontSize: 34, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#9ca3af", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Broadcast & Notifications</h1>
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Syne', serif", fontSize: 28, color: "#fff", margin: 0 }}>Studio Settings</h1>
      <div style={{ background: "#161a2a", border: "1px solid #2a2e42", borderRadius: 12, padding: 20 }}>
        <h3 style={{ color: "#fff", fontSize: 16, fontWeight: 700, margin: "0 0 16px" }}>General Settings</h3>
    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0" }}>
          ...
          <p style={{ fontSize: 12, color: T.textFaint, margin: "4px 0 0" }}>6th Ave District, Tacoma · Two Locations Serving Tacoma & Federal Way</p>
        </div>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontSize: 14, color: T.text }}>Expand Yoga · 6th Ave District</span>
                </div>
              </div>
            </div>
