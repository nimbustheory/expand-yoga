const demoConfig = {
  studioName: "EXPAND YOGA".trim(),
  studioShortName: "EXPAND",
  ...
  features: [
    ...
    { icon: "credit-card", title: "Membership Tiers", desc: "5 plans from drop-in to unlimited" },
    { icon: "star", title: "Events & Workshops", desc: "Special sessions and teacher training" },
